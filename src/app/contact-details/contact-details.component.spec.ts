...
4. TestCase for total dropdown in screen.
...
describe('ContactDetailsComponent', () => {
  ...
  it('should have 16 text fields', () => {
    ...
    expect(compiled.querySelectorAll('input[type="text"]').length == 28).toBeTruthy();
  }); //Testcase 1
  it('should have 14 checkbox', () => {
    const compiled = fixture.debugElement.nativeElement;
    expect(compiled.querySelectorAll('p-checkbox').length == 14).toBeTruthy();
  }); //Testcase 2
  it('should have 12 drop downs', () => {
    const compiled = fixture.debugElement.nativeElement;
    expect(compiled.querySelectorAll('p-dropdown').length == 12).toBeTruthy();
  }); //Testcase 4

  it('should have 3 fieldset', () => {
    const compiled = fixture.debugElement.nativeElement;
    expect(compiled.querySelectorAll('fieldset').length == 3).toBeTruthy();
  }); //Testcase 3
  ...
  it('should have save button and cancel button', () => {
    ...
    compiled.querySelectorAll('button').forEach(function (button) {
      ...
      if (!saveButton)
        saveButton = button.getAttribute('label') == "Add/ Update Location Contact";
      if (!cancelButton)
