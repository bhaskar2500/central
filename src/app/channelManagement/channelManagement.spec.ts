...
/* 
Test cases:
1. TestCase for total fieldsets in screen.
2. TestCase for total tabel in screen.
3. TestCase for total buttons in screen.
...
,InputMaskModule, MessagesModule, MessageModule,HttpClientModule
  ...
  it('should have 1 fieldset', () => {
    ...
    expect(compiled.querySelectorAll('fieldset').length==1).toBeTruthy(); //Testcase 1
  });
  it('should have 1 table', () => {
    const compiled= fixture.debugElement.nativeElement;
    expect(compiled.querySelectorAll('p-dataTable').length==1).toBeTruthy(); //Testcase 2
  });
  it('should have 3 buttons', () => {
    const compiled= fixture.debugElement.nativeElement;
    expect(compiled.querySelectorAll('button').length==3).toBeTruthy(); //Testcase 3
  });
   ...
   if(!saveButton)
          saveButton =  button.getAttribute('label') == "Save Channel Partner Updates"   ;
   if(!cancelButton)
