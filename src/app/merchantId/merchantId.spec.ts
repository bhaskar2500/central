...
*/
describe('MerchantId', () => {
  let component: MerchantId;
  let fixture: ComponentFixture<MerchantId>;
...
,InputMaskModule, MessagesModule, MessageModule,HttpClientModule
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(MerchantId);
  ...
  it('should create', () => {
   ...
   it('should have 3 text fields', () => {
    ...
    expect(compiled.querySelectorAll('input[type="text"]').length==3).toBeTruthy();
  }); //Testcase 1
  ...
  it('should have 1 fieldset', () => {
   ...
   if(!saveButton)
          saveButton =  button.getAttribute('label') == "Save Merchant ID Updates"   ;
   if(!cancelButton)
