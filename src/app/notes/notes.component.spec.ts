...
/* 
Test case for
1. TestCase for total textarea in screen.
...
,InputMaskModule, MessagesModule, MessageModule,HttpClientModule
  ...
  it('should have 3 text area', () => {
    ...
    expect(compiled.querySelectorAll('textarea').length==3).toBeTruthy();
  }); //Testcase 1
  it('should have 3 drop downs', () => {
    const compiled= fixture.debugElement.nativeElement;
    expect(compiled.querySelectorAll('p-dropdown').length==3).toBeTruthy();
  }); //Testcase 3
  ...
  it('should have 3 buttons', () => {
   ...
   if(!saveButton)
          saveButton =  button.getAttribute('label') == "Save Notes Updates"   ;
   if(!cancelButton)
